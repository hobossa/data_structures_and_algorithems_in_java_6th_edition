...
public interface Graph<V, E> {
    ...
    /**
     * Returns an iteration of all the deges of the graph.
     */
     ...
     * Note that for an undirecgted graph, this is the same result
    ...
    /**
     * Returns an iterable collection of edges for which vertex v is
     * the origin.
     * Note that for an undirected graph, this is the same result
    ...
    /**
     * Inserts and returns a new edge between vertices u and v,
